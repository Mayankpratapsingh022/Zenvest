...
Reaching FIRE transforms savings into investments, akin to breaking the S-curve of poverty with loans on mutual fund investments, leading to a wealth point where money secures a better future.</p>
        ...
        <Card  src='graph' css='w-96 h-96' size='flex justify-center items-center' loop={true} speed={1} />
        <p>Nurture your financial future! Commit to your investments for compound interest benefits and keep more in your pocket by reducing taxes and avoiding unnecessary fees.</p>
        </div>
        </div>
        </>
    )
