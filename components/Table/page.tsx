...
const items = [
  ...
  },
  {
    ...
    header: <>
           <div className="flex justify-center items-center h-full">
    <svg xmlns="http://www.w3.org/2000/svg"  className="w-24 h-24" fill="#ffffff" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
